...
title: markdown2view A4 功能说明书
summary: 面向打印、归档与项目汇报的 Markdown 文档示例。
---

# markdown2view A4 功能说明书

> 文档类型：A4 正式文档  
> 适用场景：项目说明、需求评审、方案汇报、归档交付  
> 示例目标：用一份 Markdown 展示当前 A4 文档模式支持的核心排版与导出能力。
...
正式文档常见的图片题注会放在图片下方，表格题注会放在表格上方。当前 A4 解析会结合上下文判断题注，减少普通段落被误识别为图注或表注的概率。
